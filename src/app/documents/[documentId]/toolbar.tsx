...
const ImageButton = () => {
    const { editor } = useEditorStore();
    const [isDialogOpen, setIsDisalogOpen] = useState(false);
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent>
                    ...
                    <DropdownMenuItem onClick={() => setIsDisalogOpen(true)}>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDisalogOpen} >
                <DialogContent>
                    <DialogHeader>
...
const FontFamilyButton = () => {
    ...
    const fonts = [
        ...
        { label: "Georiga", value: "Georgia" },
        { label: "Verdana", value: "Verdana" },
        { label: "Inter", value: "Inter" },
        { label: "Comic Sans", value: "Comic Sans" },
        { label: "Serif", value: "seris" },
    ]
